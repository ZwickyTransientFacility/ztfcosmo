...
1. Download [these data](http://ztfcosmo.in2p3.fr/download/data) (http://ztfcosmo.in2p3.fr/download/data) and uncompress the zip file. Move the generated directory anywhere you want (e.g. in `'~/data/ztf/'`)
